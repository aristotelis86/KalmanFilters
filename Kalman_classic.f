Ccccc This is a classic Kalman filter which utilizes data history to eliminate systematic errors
...
110     y=z-ss
	...
	open (unit=86, file='Variance_rec.txt', status='old', access='append')
	write(86,*) V
	close(86)
...
Cc        Var=(1.0/index_r)*S2-(history_index_r/index_r)*(Mean**2)
